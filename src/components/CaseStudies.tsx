...
const cases = [
  { name: "Michael T.", city: "Miami, FL", before: "Inconsistent referrals, 3-4 deals/mo", after: "Predictable system, 28 deals/mo", spend: "$4,500", leads: "312", closings: "28", volume: "$11.2M", time: "90 Days" },
  { name: "Sarah J.", city: "Dallas, TX", before: "Buying Zillow leads, low conversion", after: "Exclusive funnels, 35 deals/mo", spend: "$6,000", leads: "420", closings: "35", volume: "$14.5M", time: "120 Days" },
  { name: "David R.", city: "Chicago, IL", before: "Relying on realtors only", after: "Direct-to-consumer dominance", spend: "$3,800", leads: "285", closings: "22", volume: "$8.8M", time: "60 Days" },
  { name: "Elena M.", city: "Los Angeles, CA", before: "High ad spend, zero tracking", after: "Optimized ROAS, 42 deals/mo", spend: "$8,500", leads: "550", closings: "42", volume: "$28.5M", time: "6 Months" },
  { name: "James W.", city: "Atlanta, GA", before: "Stuck at 5 deals/mo for years", after: "Scaled team, 31 deals/mo", spend: "$5,200", leads: "380", closings: "31", volume: "$12.4M", time: "90 Days" },
